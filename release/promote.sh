...
PYTORCH_VERSION=${PYTORCH_VERSION:-1.7.1}
TORCHVISION_VERSION=${TORCHVISION_VERSION:-0.8.2}
TORCHAUDIO_VERSION=${TORCHAUDIO_VERSION:-0.7.2}
TORCHTEXT_VERSION=${TORCHTEXT_VERSION:-0.8.1}
TORCHSERVE_VERSION=${TORCHSERVE_VERSION:-0.3.0}
TORCHCSPRNG_VERSION=${TORCHCSPRNG_VERSION:-0.1.4}
...
promote_pypi torchserve conda "${TORCHSERVE_VERSION}"
promote_pypi torch-model-archiver conda "${TORCHSERVE_VERSION}"
